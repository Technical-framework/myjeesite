...
<link href="${ctxStatic}/bootstrap/bootstrap-table/src/bootstrap-table.css" type="text/css" rel="stylesheet"/>
<script src="${ctxStatic}/bootstrap/bootstrap-table/src/bootstrap-table.js" type="text/javascript"></script>
